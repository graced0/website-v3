...
function Hero({ fullpageRef, nightMode }: { fullpageRef: any, nightMode: boolean }) {
    ...
    return (
        <div className="HeroContainer" style={{
            ...
            <h1
                className="HeroTitle d-none d-sm-block"
                style={{
                    fontFamily: 'Lexend',
                    fontWeight: 600,
                    fontSize: '6rem',
                ...
                <ul style={{
                    ...
                    <li style={{ margin: '0 1rem' }}>
                        <a href="https://www.linkedin.com/in/gracendo/" target="_blank" rel="noopener noreferrer">
                            <svg xmlns="http://www.w3.org/2000/svg" width="3rem" height="3rem" fill="inherit" className="bi bi-linkedin" viewBox="0 0 16 16">
                    ...
                    <li style={{ margin: '0 1rem' }}>
                        <a href="https://github.com/graced0" target="_blank" rel="noopener noreferrer">
                            <svg xmlns="http://www.w3.org/2000/svg" width="3rem" height="3rem" fill="inherit" className="bi bi-github" viewBox="0 0 16 16">
                    ...
                    <li style={{ margin: '0 1rem' }}>
                        <a href="https://open.spotify.com/user/gndo2002?si=a14cd0db73e44e37" target="_blank" rel="noopener noreferrer">
                            <svg xmlns="http://www.w3.org/2000/svg" width="3rem" height="3rem" fill="inherit" className="bi bi-spotify" viewBox="0 0 16 16">
            ...
            <svg
                ...
                width="2.5rem"
                height="2.5rem"
                fill={nightMode ? "#fff" : "#111"}
                className="Arrow bi bi-arrow-down d-none d-lg-block"
                viewBox="0 0 16 16"
